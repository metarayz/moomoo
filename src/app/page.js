...
export default function Home() {
  ...
  return (
    <div className="font-body">
        ...
        <div className="max-w-[2000px] md:p-8 p-5 md:px-12 flex mx-auto justify-between items-start">
          <div className="max-w-max items-center gap-2 rounded-md text-4xl font-bold flex">
            <div className="md:block hidden">
              <div className="text-[160px] rounded-md text-[#800] font-extrabold drop-shadow-[0_2px_0_rgba(0,0,0,1)] [text-shadow:2px_2px_0_#fff,2px_-2px_0_#fff,-2px_2px_0_#fff,-2px_-2px_0_#fff,2px_0px_0_#fff,0px_2px_0_#fff,-2px_0px_0_#fff,0px_-2px_0_#fff]">
                $moomoo
              </div>
              <a
                ...
                className="text-right font-black text-[#025702] text-[30px] mt-[-15px] italic pr-3 underline hover:scale-105 hover:text-[#800]"
              >
      ...
      <div className="h-10 items-center absolute w-full z-10 flex text-lg font-black bg-[#fee8ca] shadow-lg border-b-2 border-black">
      ...
      <div id="hero" className="h-[100dvh] relative overflow-x-hidden">
        <div
          className="absolute inset-0 bg-no-repeat bg-cover bg-center md:block hidden"
        ...
        >
          ...
          />
          <div className="bg-[transparent] text-white font-bold absolute md:bottom-26 bottom-30 left-1/2 translate-x-[-50%] w-full rotate-[-1deg] text-center md:text-5xl text-2xl p-0 px-10 drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] z-20">
            2 hours before mumu... <br />
            <div className="md:text-7xl text-4xl whitespace-nowrap">
              there was{" "}
              <strong className="text-[#800] [text-shadow:2px_2px_0_#fff,2px_-2px_0_#fff,-2px_2px_0_#fff,-2px_-2px_0_#fff,2px_0px_0_#fff,0px_2px_0_#fff,-2px_0px_0_#fff,0px_-2px_0_#fff] drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
                moomoo
              </strong>
              .
            </div>
        ...
        <div className="mt-5 md:hidden">
          <div className="text-[60px] mt-12 text-center rounded-md text-[#800] font-extrabold">
            $moomoo
          </div>
          <div className="mt-[-14px]">
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="text-center font-black text-[#025702] text-[20px] italic pr-3 hover:scale-105 hover:text-[#800]"
            >
              <div>THE OG 4CHAN BULL</div>
            </a>
          </div>
          ...
          <div className="text-black font-bold  w-full text-center text-xl p-0 px-10 mt-12">
            ...
            <div className="flex justify-center absolute bottom-10 left-1/2 translate-x-[-50%]">
              <span className="animate-bounce">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M12 5v14m0 0l-7-7m7 7l7-7"
      ...
      <div
        id="about"
        className="relative bg-[#fee8ca] py-20 overflow-hidden flex items-center justify-center border-t-2 border-black"
      >
        {/* hero.png as faint background */}
        ...
        <div className="relative z-10 max-w-[1300px] mx-auto text-center space-y-8 flex flex-col items-center px-5">
          ...
          <p className="md:text-3xl text-lg font-semibold px-2 max-w-[950px]">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12">
          <div className="md:text-2xl font-bold text-black space-y-4 text-center md:text-left">
            ...
            <div className="text-left text-lg">
              <div>
                Ticker: <span className="font-extrabold">$moomoo</span>
              </div>
              <div>
                Total Supply:{" "}
                <span className="font-extrabold">1,000,000,000</span>
              </div>
              <div>
                CA:{" "}
                <span
                  className="font-extrabold md:text-lg text-xs"
                  id="contract-address"
                >
      ...
      >
        {/* 4chan background */}
        <div className="absolute inset-0 w-full h-full opacity-20 z-0 pointer-events-none select-none">
          <Image
            src="/4chan.png"
      ...
      <section
        id="roadmap"
        className="relative bg-[#fee8ca] py-20 border-t-2 border-black flex flex-col items-center justify-center"
      >
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 w-full">
            <div className="flex-shrink-0 hidden md:block">
              <Image
                ...
                width={400}
                height={400}
                className="rounded-full border-5 border-black shadow-lg aspect-square scale-x-[-1]"
                draggable={false}
                style={{ pointerEvents: "none", userSelect: "none" }}
              />
            </div>
            <ul className="space-y-6 text-left w-full md:text-xl text-shadow-lg">
              <li className="bg-[white] border-l-4 border-[#800] px-6 py-4 rounded-xl shadow flex items-center gap-4">
      ...
      {/* footer */}
      <footer className="w-full bg-[#fee8ca] border-t-2 border-black py-8 flex flex-col items-center gap-4 relative z-20">
        <div className="flex flex-col items-center gap-2">
          {/* Logo */}
          <span className="md:text-[60px] text-[30px] font-extrabold text-[#800]">
            $moomoo
          </span>
